...
def test_list():
    ...
    test_movie_service.add_movie(2, "Hard", "Shooting", "Action")
    test_client_service.add_client(2, "Harangus Dan")
    test_movie_service.list_movie()
    test_client_service.list_client()